...
class image extends connection implements query{
        ...
        public function checker(){
            if($this->type=='promozione'){
                ...
                if(empty($okstart)){throw new exeption('error','Orario non in formato GG-MM-AAAA o non calendarizzato');}
                preg_match($this->regex, $this->finish, $okfinish, PREG_OFFSET_CAPTURE);
                if(empty($okfinish)){throw new exeption('error','Orario non in formato GG-MM-AAAA o non calendarizzato');}
