...
<body>
    ...
    <div id="menu">
        <ul>
            <li><a href="../pubblico/home.php"><span xml:lang="en">Home</span></a></li>
    ...
    <div id="content">
	   ...
	   <form id="change" action="../privato/orario.php" method="post">
        <fieldset id="inputs">
            <input id="feriali" name="feriale" type="text" value="<?php echo $riga['feriale'];?>"><br/>
            <input id="sabato" name="sabato" type="text" value="<?php echo $riga['sabato'];?>"><br/>
            <input id="festivo" name="festivi" type="text" value="<?php echo $riga['festivi'];?>"><br/>
