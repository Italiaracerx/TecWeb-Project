...
Per prima cosa viene caricata una delle pagine contenute nella cartella \textit{HTML}, questa inizializzerà un oggetto controller e uno degli oggetti disponibili disponibili nella cartella \textit{page} che definiremo come oggetto di tipo \textit{type\_page}.
